...
import { RouterLinkMatch, RouterLinkMatchModule } from '@ngrx-utils/ng';
...
describe('RouterLinkMatch', () => {
  ...
  it('should add class to element when route is match', fakeAsync(
    inject([Router], (router: Router) => {
      const fixture = createRoot(RootComponent);
...
class Test4Component {
  ...
  @ViewChild(RouterLinkMatch)
  active: RouterLinkMatch;
...
function createRoot(type: any): ComponentFixture<any> {
