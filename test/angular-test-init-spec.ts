 ...
 */
function patchTestBedToDestroyFixturesAfterEveryTest(_testBed: any) {
  // Original resetTestingModule function of the TestBed.
  const _resetTestingModule = _testBed.resetTestingModule;
  ...
  _testBed.resetTestingModule = function() {
    try {
      this._activeFixtures.forEach((fixture: any) => fixture.destroy());
    } finally {
  ...
  afterEach(() => _testBed.resetTestingModule());
}
