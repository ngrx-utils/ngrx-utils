...
describe('BooksReducer', () => {
  ...
  describe('SEARCH_COMPLETE & LOAD_SUCCESS', () => {
    ...
    it('should add all books in the payload when none exist', () => {
      noExistingBooks(SearchComplete, fromBooks.initialState, initialState, [book1, book2]);

      noExistingBooks(LoadSuccess, fromBooks.initialState, initialState, [book1, book2]);
    });
